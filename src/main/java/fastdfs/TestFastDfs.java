...
public class TestFastDfs {
    ...
    public String conf_filename = "E:\\github\\JavaTest\\src\\main\\resource\\conf\\fdfs_client.conf"; 
     
    public String local_filename = "E:\\111.png";
 
    public String remote_filename = "M00/00/00/wKjEhlZwzZ6ARDoSAABd29PC_9g183.png";
    ...
    public static void main(String[] args){
    	...
    	fdfs.testGetFileInfo();
    	fdfs.testGetFileMate();
    }
    ...
    public void testGetFileMate(){ 
        try { 
            ...
            StorageClient storageClient = new StorageClient(trackerServer, 
                    storageServer); 
            NameValuePair nvps [] = storageClient.get_metadata("group1", remote_filename); 
